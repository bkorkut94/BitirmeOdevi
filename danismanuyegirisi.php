...
<body>
    ...
    $bilgilerimsor=$db->prepare("SELECT * from tablo_danisman where danisman_tcnnumara=:danisman_tcnnumara");
    $bilgilerimsor->execute(array('danisman_tcnnumara' => $_GET['danisman_tcnnumara']));
    ...
    <div align="center" class="container">
        <form action="danismanuyeislemi.php" method="POST">
            <div class="form-group">
                <label for="danisman_kullaniciadi" class="col-form-label">Kullanızı Adınız:</label>
                <input type="number" onfocus="degistir1()" onfocusout="degistir2()" onblur="kontrol1()" onkeydown="islem1()" onmouseup="gel1()" onmousedown="ayril1()" oncontextmenu="duzen1()" value="<?php echo $bilgilerimcek['danisman_kullaniciadi'] ?>"  name="danisman_kullaniciadi" required="" class="form-control is-valid">
            </div>
            <div class="form-group">
                <label for="danisman_adi" class="col-form-label">Adınız:</label>
                <input type="text" onfocus="degistir3()" onfocusout="degistir4()" onmouseup="gel3()" onmousedown="ayril3()" value="<?php echo $bilgilerimcek['danisman_adi'] ?>" name="danisman_adi" required="" class="form-control is-invalid">
            </div>
            <div class="form-group">
                <label for="danisman_soyadi" class="col-form-label">Soyadınız:</label>
                <input type="text" onfocusin="degistir5()" onfocusout="degistir6()" onmouseup="gel2()" onmousedown="ayril2()" value="<?php echo $bilgilerimcek['danisman_soyadi'] ?>" name="danisman_soyadi" required=""  class="form-control is-valid">
            </div>
            <div class="form-group">
                <label for="danisman_tcnnumara" class="col-form-label">TC Numaranız:</label>
                <input type="number" onfocusin="degistir7()" onfocusout="degistir8()" onblur="kontrol2()" onkeypress="islem2()" onmouseup="gel5()" onmousedown="ayril5()" oncontextmenu="duzen1()" value="<?php echo $bilgilerimcek['danisman_tcnnumara'] ?>" name="danisman_tcnnumara" required=""  class="form-control is-invalid">
            </div>
            <div class="form-group">
                <label for="danisman_sifre" class="col-form-label">Şifrenizi Belirleyin</label>
                <input type="text" onmouseup="gel4()" onmousedown="ayril4()" required="" name="danisman_sifre" placeholder="Şifre Oluşturun" class="form-control is-valid">
            </div>
            <input hidden="" value="<?php echo $bilgilerimcek['danisman_tcnnumara']?>" name="danisman_tcnnumara1">
